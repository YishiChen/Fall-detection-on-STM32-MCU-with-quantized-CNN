...
#define AI_NETWORK_MODEL_SIGNATURE     "0xeda194e80a88cf8cfaa824d06b6db41a"
...
#define AI_TOOLS_DATE_TIME   "Sat Jun 15 23:21:45 2024"
...
/* Array#34 */
AI_ARRAY_OBJ_DECLARE(
  pool_26_output_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#36 */
AI_ARRAY_OBJ_DECLARE(
  nl_29_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 2, AI_STATIC)
...
/* Array#56 */
AI_ARRAY_OBJ_DECLARE(
  gemm_28_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 1536, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 768, 2, 1, 1), AI_STRIDE_INIT(4, 4, 3072, 6144, 6144),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 48, 1), AI_STRIDE_INIT(4, 4, 4, 256, 12288),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 24, 1), AI_STRIDE_INIT(4, 4, 4, 256, 6144),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, &pool_26_output_array, NULL)

/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  pool_26_output0, AI_STATIC,
  11, 0x0,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  26, 0x0,
  AI_SHAPE_INIT(4, 1, 6, 50, 1), AI_STRIDE_INIT(4, 4, 4, 24, 1200),
  1, &serving_default_input_10_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &pool_26_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_28_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_28_weights),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_21_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_24_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_23_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_23_weights, &conv2d_7_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &nl_20_nl_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_22_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_22_weights, &conv2d_7_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_18_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_17_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_17_weights, &conv2d_7_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_16_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_16_weights, &conv2d_7_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_19_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_11_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_14_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_13_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_13_weights, &conv2d_7_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &nl_10_nl_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_12_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_12_weights, &conv2d_7_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_6_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_9_weights, &conv2d_4_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_8_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2d_8_weights, &conv2d_7_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 121664, 1, 1),
    121664, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 19632, 1, 1),
    19632, NULL, NULL),
  ...
  &conv2d_4_layer, 0xfb1466d4, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_input_10_output_array.data = AI_PTR(g_network_activations_map[0] + 12288);
    serving_default_input_10_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12288);
    ...
    conv2d_4_output_array.data = AI_PTR(g_network_activations_map[0] + 13488);
    conv2d_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 13488);
    ...
    nl_7_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 1536);
    nl_7_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1536);
    ...
    nl_8_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 1536);
    nl_8_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1536);
    conv2d_9_output_array.data = AI_PTR(g_network_activations_map[0] + 7344);
    conv2d_9_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7344);
    ...
    eltwise_10_output_array.data = AI_PTR(g_network_activations_map[0] + 13488);
    eltwise_10_output_array.data_start = AI_PTR(g_network_activations_map[0] + 13488);
    ...
    conv2d_12_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_12_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    nl_12_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 7680);
    nl_12_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7680);
    conv2d_13_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_13_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    nl_13_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 7680);
    nl_13_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7680);
    conv2d_14_output_array.data = AI_PTR(g_network_activations_map[0] + 13488);
    conv2d_14_output_array.data_start = AI_PTR(g_network_activations_map[0] + 13488);
    conv2d_11_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_11_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    eltwise_15_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    eltwise_15_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    nl_15_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    nl_15_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    ...
    conv2d_16_output_array.data = AI_PTR(g_network_activations_map[0] + 12288);
    conv2d_16_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12288);
    nl_16_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    nl_16_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_17_output_array.data = AI_PTR(g_network_activations_map[0] + 7680);
    conv2d_17_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7680);
    nl_17_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    nl_17_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_18_output_array.data = AI_PTR(g_network_activations_map[0] + 7680);
    conv2d_18_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7680);
    eltwise_20_output_array.data = AI_PTR(g_network_activations_map[0] + 7680);
    eltwise_20_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7680);
    ...
    conv2d_22_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_22_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    nl_22_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 7680);
    nl_22_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7680);
    ...
    nl_23_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 7680);
    nl_23_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7680);
    conv2d_24_output_array.data = AI_PTR(g_network_activations_map[0] + 13488);
    conv2d_24_output_array.data_start = AI_PTR(g_network_activations_map[0] + 13488);
    conv2d_21_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_21_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    ...
    nl_25_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    nl_25_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    ...
    gemm_28_output_array.data = AI_PTR(g_network_activations_map[0] + 3072);
    gemm_28_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3072);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 0);
    conv2d_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 4608);
    conv2d_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4608);
    conv2d_7_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_weights_array.data = AI_PTR(g_network_weights_map[0] + 4864);
    conv2d_7_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4864);
    conv2d_7_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_bias_array.data = AI_PTR(g_network_weights_map[0] + 8960);
    conv2d_7_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 8960);
    conv2d_8_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_weights_array.data = AI_PTR(g_network_weights_map[0] + 9024);
    conv2d_8_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 9024);
    conv2d_9_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_weights_array.data = AI_PTR(g_network_weights_map[0] + 12096);
    conv2d_9_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 12096);
    conv2d_6_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 16192);
    conv2d_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 16192);
    conv2d_12_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_12_weights_array.data = AI_PTR(g_network_weights_map[0] + 32576);
    conv2d_12_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 32576);
    conv2d_13_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_13_weights_array.data = AI_PTR(g_network_weights_map[0] + 36672);
    conv2d_13_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 36672);
    conv2d_14_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_14_weights_array.data = AI_PTR(g_network_weights_map[0] + 39744);
    conv2d_14_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 39744);
    conv2d_11_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_11_weights_array.data = AI_PTR(g_network_weights_map[0] + 43840);
    conv2d_11_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 43840);
    conv2d_19_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_19_weights_array.data = AI_PTR(g_network_weights_map[0] + 60224);
    conv2d_19_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 60224);
    conv2d_16_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_16_weights_array.data = AI_PTR(g_network_weights_map[0] + 76608);
    conv2d_16_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 76608);
    conv2d_17_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_17_weights_array.data = AI_PTR(g_network_weights_map[0] + 80704);
    conv2d_17_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 80704);
    conv2d_18_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_18_weights_array.data = AI_PTR(g_network_weights_map[0] + 83776);
    conv2d_18_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 83776);
    conv2d_22_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_22_weights_array.data = AI_PTR(g_network_weights_map[0] + 87872);
    conv2d_22_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 87872);
    conv2d_23_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_23_weights_array.data = AI_PTR(g_network_weights_map[0] + 91968);
    conv2d_23_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 91968);
    conv2d_24_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_24_weights_array.data = AI_PTR(g_network_weights_map[0] + 95040);
    conv2d_24_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 95040);
    conv2d_21_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_21_weights_array.data = AI_PTR(g_network_weights_map[0] + 99136);
    conv2d_21_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 99136);
    gemm_28_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_28_weights_array.data = AI_PTR(g_network_weights_map[0] + 115520);
    gemm_28_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 115520);
    return true;
  }
